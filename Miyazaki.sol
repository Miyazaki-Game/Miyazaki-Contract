...
contract DividendDistributor is IDividendDistributor, SafeToken {
    ...
    uint256 public minimumTokenBalanceForDividends = 2100000 * (10**9); // user must hold 2,100,000 token
...
contract MIYAZAKI is
    BASEToken("Doges Spirited Howling Castle Game", "MIYAZAKI", 21e18, 9),
    SafeToken,
    LockToken
{
    using SafeMath for uint256;
